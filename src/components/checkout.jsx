...
function Checkout() {
  const checkbox = document.getElementById('c_create_account');
  const content = document.getElementById('create_an_account');
...
const checkbox2 = document.getElementById('c_ship_different_address');
const content2 = document.getElementById('ship_different_address');
            ...
            <div className="row">
              <div className="col-md-6 mb-5 mb-md-0">
                ...
                <div className="p-3 p-lg-5 border bg-white">
                  ...
                  <div className="form-group">
                    <label htmlFor="c_create_account" className="text-black" data-bs-toggle="collapse" href="#create_an_account" role="button" aria-expanded="false" aria-controls="create_an_account"><input type="checkbox" defaultValue={0} id="c_create_account" /> Create an account?</label>
