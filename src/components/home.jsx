...
<>
      <div>
        {/* Start Hero Section */}
        <HeroSection heroTitle="Modern Interior Design Studio"/>
        {/* End Hero Section */}
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                <a className="product-item" href="cart.html">
                  <img src="./product-1.png" className="img-fluid product-thumbnail" />
              ...
              <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                <a className="product-item" href="cart.html">
                  <img src="./product-2.png" className="img-fluid product-thumbnail" />
              ...
              <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                <a className="product-item" href="cart.html">
                  <img src="./product-3.png" className="img-fluid product-thumbnail" />
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div className="product-item-sm d-flex">
                  <div className="thumbnail">
                    <img src="./product-1.png" alt="Image" className="img-fluid" />
                  </div>
                  <div className="pt-3">
                    <h3>Nordic Chair</h3>
              ...
              <div className="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div className="product-item-sm d-flex">
                  <div className="thumbnail">
                    <img src="./product-2.png" alt="Image" className="img-fluid" />
                  </div>
                  <div className="pt-3">
              ...
              <div className="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div className="product-item-sm d-flex">
                  <div className="thumbnail">
                    <img src="./product-3.png" alt="Image" className="img-fluid" />
                  </div>
                  <div className="pt-3">
            ...
            <div className="row">
              <div className="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                <div className="post-entry">
                  <a href="#" className="post-thumbnail"><img src="./post-1.jpg" alt="Image" className="img-fluid" /></a>
              ...
              <div className="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                <div className="post-entry">
                  <a href="#" className="post-thumbnail"><img src="./post-2.jpg" alt="Image" className="img-fluid" /></a>
                  <div className="post-content-entry">
              ...
              <div className="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                <div className="post-entry">
                  <a href="#" className="post-thumbnail"><img src="./post-3.jpg" alt="Image" className="img-fluid" /></a>
                  <div className="post-content-entry">
